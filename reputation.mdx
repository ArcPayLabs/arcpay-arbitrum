...
description: "Order-backed reputation for Arbitrum agents."
---

ArcPay includes an `AgentReputationBook` contract on Arbitrum Sepolia. It lets order participants attach score and dispute evidence to a completed, fulfilled, refunded, or failed agent order.
...
The app records the review on Arbitrum and mirrors evidence into ArcPay audit records.
