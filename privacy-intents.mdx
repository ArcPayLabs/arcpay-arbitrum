...
description: "A practical privacy primitive for Arbitrum agent treasury flows."
---

Arbitrum does not currently ship a native treasury privacy layer. ArcPay adds a builder-usable privacy intent contract for agent payment workflows.
