---
title: "Roadmap"
description: "What ships next for ArcPay Arbitrum."
---
...
- collect feedback from Arbitrum builders running testnet agents
...
- publish a reusable starter kit for x402 paid Arbitrum agents
...
## Phase 3: Deeper Arbitrum-Native Agent Infrastructure
...
- add Arbitrum Reactivity subscriptions for order, invoice, card, policy, and privacy events
- add Arbitrum Data Streams schemas for agent reputation, service telemetry, and beta usage
- add more Arbitrum-native DeFi hooks as stable testnet router/vault infrastructure matures

## Phase 4: Public Beta and Ecosystem Growth

- launch an ArcPay Arbitrum X account
