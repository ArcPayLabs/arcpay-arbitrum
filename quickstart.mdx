---
title: "Quickstart"
description: "Run ArcPay Arbitrum locally and verify live Arbitrum Sepolia flows."
---
...
Use a funded Arbitrum Sepolia wallet for live smoke tests.
...
1. Connect an EVM wallet and switch to Arbitrum Sepolia.
