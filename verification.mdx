...
| x402 health | `https://arbitrum-x402.20.208.46.195.nip.io/health` |
| x402 demo | `https://arbitrum-x402.20.208.46.195.nip.io/x402/demo` |
...
curl https://arbitrum-x402.20.208.46.195.nip.io/x402/payment-requirements/research-agent
```
